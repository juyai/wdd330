...
export default class QuakesController {
  ...
  async init() {
    // use this as a place to grab the element identified by this.parent, do the initial call of 
    //this.initPos(), and display some quakes by calling this.getQuakesByRadius()
  ...
  async getQuakesByRadius(radius = 100) {
    // this method provides the glue between the model and view. Notice it first 
    //goes out and requests the appropriate data from the model, then it passes it
    // to the view to be rendered set loading message
